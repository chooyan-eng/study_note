...
| T02 | データモデルの定義 | 未着手 | Phase 1 |
| T03 | 基本UIの実装（非機能） | 未着手 | Phase 1 |
| T04 | フリーハンド描画の実装 | 未着手 | Phase 1 |
| T05 | 直線（実線・破線）の実装 | 未着手 | Phase 1 |
| T06 | Undo / Redo の実装 | 未着手 | Phase 1 |
| T07 | 消しゴムの実装 | 未着手 | Phase 1 |
| T08 | レイヤー機能の実装 | 未着手 | Phase 3 |
| T09 | 計算記号図形（スタンプ）の実装 | 未着手 | Phase 2 |
